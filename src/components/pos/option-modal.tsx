    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          <div className="text-base font-bold">{menuText(item.name, item.translations)}</div>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-4 overflow-auto">
          {groups.map((g) => (
            <div key={g.key}>
              <div className="mb-2 text-xs font-semibold text-muted-foreground">{menuText(g.label, g.translations)}</div>
              <div className="flex flex-wrap gap-2">
                {g.choices.map((c) => {
                  ...
                  return (
                    ...
                    >
                      <div className="font-bold">{menuText(c.label, c.translations)}</div>
        ...
        <div className="flex items-center justify-between border-t border-dashed border-border pt-2">
          <div className="text-sm text-muted-foreground">{t('optionModal.price')}</div>
